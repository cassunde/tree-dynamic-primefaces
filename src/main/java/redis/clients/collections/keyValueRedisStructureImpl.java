...
class keyValueRedisStructureImpl<T> implements keyValueRedisStructure<T> {
	...
	keyValueRedisStructureImpl(Jedis jedis, Class<T> clazz, String nameSpace, int ttlSeconds) {
		this.clazz = clazz;
